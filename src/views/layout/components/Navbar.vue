<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <!-- <el-dropdown-item>
            <div @click="openAdminDialog">个人信息</div>
          </el-dropdown-item> -->
    ...
    <el-dialog title="" :visible.sync="showDialog" width="80%" :before-close='closeDialog'>
      <admin :config="adminConfig" @close="closeDialog" v-if="dialogConfig.status == dialogConfig.ADMIN"></admin>
    </el-dialog>

    <el-dialog title="修改密码" :visible.sync="showPasswordForm" width="30%" :before-close='closePwdDialog'>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="changePassword('ruleForm')" :disabled="waitAddNotice" :loading="waitAddNotice">确 定</el-button>
      </span>
    </el-dialog>
  </el-menu>
</template>
...
export default {
  ...
  computed: {
    showDialog(){ return this.dialogConfig.status !== -1; },
    ...mapGetters([
      'sidebar',
      'name',
      'avatar'
  ...
  methods: {
    closeDialog(){ this.dialogConfig.status = -1; },

    closePwdDialog(){ 
      this.formForNotive.new = '';
      this.formForNotive.newAgain = '';
      this.formForNotive.old = '';

      this.showPasswordForm = false;
    },

    openAdminDialog(){
      let o = this.dialogConfig;
