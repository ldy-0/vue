<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="CreateItem">选择商品</el-button>
		</div>
		<!--顶部菜单结束 -->
		<!--中间表格开始 -->
      ...
      width="50">
			...
			<el-table-column label="图片">
				<template slot-scope="scope">
					<img @click="handlePictureCardPreview(scope.row)" :src="scope.row.goods_image" style="width:100px">
				</template>
			</el-table-column>
			<el-table-column label="商品名称" prop="goods_name">
			</el-table-column>
			<el-table-column label="商品价格(元/天)" prop="goods_price">
			</el-table-column>
		...
		<!-- 表格分页开始 -->
		<el-pagination @size-change="handleSizeChange_table" @current-change="handleCurrentChange_table" :current-page="listQuery_Recommend.page" :page-sizes="[10,20,30]"
				:page-size="listQuery_Recommend.limit" layout="total, sizes, prev, pager, next" background :total="total_Recommend">
		</el-pagination>
		<!--表格分页结束 -->
		<!--中间表格结束 -->
		<!--内容弹框开始 -->
		<el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
			<el-table :data="goodList" style="width: 100%">
				...
				<el-table-column label="商品编号" prop="goods_serial">
				</el-table-column>
				<el-table-column label="商品名称" prop="goods_name">
				</el-table-column>
			...
			<!-- 弹框分页开始 -->
			<el-pagination @size-change="handleSizeChange_Goods" @current-change="handleCurrentChange_Goods" :current-page="listQuery_Goods.page" :page-sizes="[10,20,30]"
					:page-size="listQuery_Goods.limit" layout="total, sizes, prev, pager, next" background :total="total_Goods">
			</el-pagination>
			<!--弹框分页结束 -->
		</el-dialog>
		<!-- 内容弹框结束-->
