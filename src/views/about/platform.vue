<template>
  <div class="platform_wrap">
    ...
    <div class="main_wrap">
      ...
      <div class="contact_wrap center">
        <div class="contact_item_wrap s_bg_f" v-for="(item, index) in contactList" :key="index">
          <div class="contact_item_icon">
            <img :class="[item.class]" :src="item.icon" alt="">
          </div>

          <div class="contact_title">{{item.title}}</div>
          <div class="contact_value bold mt20">{{item.value}}</div>
        </div>
      </div>
    </div>
    ...
    <div class="location_wrap bg mt50">
      <c-map ref="map" class="map_wrap"></c-map>
    </div>
  </div>
</template>
