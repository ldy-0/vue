      ...
      <div class="">
        ...
        <div class="m_contact_wrap">
          <div class="contact_info flex">
            <div class="i_contact">
              <img class="img" :src="contactInfo.contact_image" alt="">
            </div>

            <div class="contact_list_wrap">
              <div class="contact_item flex ellipsis s_fc_12" v-for="(item, index) in contactList" :key="index">
                ...
                <div class="ml50">{{contactInfo[item.from]}}</div>
              </div>
            </div>
          </div>
        </div>
