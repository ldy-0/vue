...
<el-form :model="formForNotive" ref="ruleForm" :rules="rules" style="padding-left:100px;width:80%">
    ...
    <el-form-item label="定位" :label-width="formLabelWidth">
        ...
        <br>
        <p class="s-margin-left80 s-margin-justify ">纬度：{{position.lat}},经度：{{position.lng}}</p>
    </el-form-item>
    ...
    <p class="s-margin-left80 s-margin-justify">请选择一张图片,建议尺寸： 宽80*高80</p>
    ...
    <p class="s-margin-left80 s-margin-justify">请选择一张图片,建议尺寸： 宽690*高390</p>
    ...
    <p class="s-margin-left80 s-margin-justify">最多可选择9张图片,建议尺寸： 宽210*高210</p>
