...
export default {
  data(){
    return {
      freightType: { title: "运费类型", list: [{ title: '固定运费', value: 1, }, { title: '运费模板', value: 2, }], value: 1, alert: null, width: '120px', },
      freight: { title: "运费", value: "", alert: null, isZero: true, width: '120px', },
      freightTemp: { title: "运费模板", list: [], value: '', alert: null, width: '120px', },
    };
  },
