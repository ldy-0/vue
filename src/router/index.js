...
export let asyncRouterMapSeller = [
  {
    ...
    children: [{
      ...
      meta: { roles: 'setting_normal', title: 'setting', noCache: true, desc: 'APPLOGO', icon: 'setting', },
    }],
  },

  {
    path: '/company', // 企业介绍
    component: Layout,
    meta: { roles: 'company', desc: '设置', },
    redirect: '/company/index',
    children: [{
      path: 'company',
      name: 'company',
      component: () => import('@/views/setting/company/index'),
      meta: { roles: 'company', title: 'company', noCache: true, desc: '企业介绍', icon: 'setting', },
    }],
  },

  {
    ...
    children: [{
      ...
      meta: { roles: 'contact', title: 'contact', noCache: true, desc: '联系我们', icon: 'setting', },
    }],
  },

  {
    ...
    children: [{
      ...
      name: 'news',
      meta: { roles: 'news_list', title: 'news', icon: 'message', noCache: true, desc: '新闻资讯', },
    }],
  },

  {
    ...
    children: [{
      ...
      name: "banner",
      meta: { roles: 'banner', title: "banner", noCache: true, desc: '轮播图', },
    }],
  },
