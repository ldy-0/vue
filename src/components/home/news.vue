<template>
  <div class="m_news_wrap s_fc_f">
    <div class="article_container bg" :style="{ backgroundImage: `url(${articleBg})` }">
      ...
      <div class="article_wrap">
        <div class="article_list_wrap flex s_fc_f">
          <div class="article_item flex pointer" :class="{article_item_head: index % 3 == 0 }" v-for="(item, index) in articleList" :key="index" @click="goNews(item)">
    ...
    <div class="video_wrap second_video_wrap flex" v-if="secondVideoList.length">
      <div class="half">
...
export default {
  ...
  computed: {
    ...
    firstVideo(){ return this.firstVideoList[this.firstIndex] ? this.firstVideoList[this.firstIndex].video : { url: '', }; },
    secondVideo(){ return this.secondVideoList[this.secondIndex] ? this.secondVideoList[this.secondIndex].video : { url: '', }; },
  },
